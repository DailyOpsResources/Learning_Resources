...
Create a user: sudo adduser <username>  <br>
Add user to a group: sudo usermod -aG <groupname> <username>  <br>
Change user password: sudo passwd <username>  <br>
Grant sudo privileges: sudo visudo  <br>
